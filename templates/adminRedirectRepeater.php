...
<div class="form-group repeater" data-index="<?php echo esc_attr($index); ?>">
    ...
    <div class="form-repeater-block">
        <div class="form-radio">
            ...
            <div class="form-radio-option">
                <input type="radio" class="form-check-input ip_action_from_country" id="ip_action_from_country__<?php echo esc_attr($index); ?>" name="ip_action[<?php echo esc_attr($index); ?>]" value="from_country" <?php checked($ip_action_value, 'from_country', true); ?><?php if (!isset($redirect)) echo ' checked'; ?>>
            ...
            <div class="form-radio-option">
                <input type="radio" class="form-check-input ip_action_not_from_country" id="ip_action_not_from_country__<?php echo esc_attr($index); ?>" name="ip_action[<?php echo esc_attr($index); ?>]" value="not_from_country" <?php checked($ip_action_value, 'not_from_country', true); ?>>
    ...
    <div class="form-repeater-block">
        ...
        <input type="text" class="form-control redirect-message-before-input" id="redirect_message_before_<?php echo esc_attr($index); ?>" name="redirect_message_before[<?php echo esc_attr($index); ?>]" value="<?php echo isset($redirect['redirect_message_before']) ? esc_attr($redirect['redirect_message_before']) : ''; ?>" required>
    ...
    <div class="form-repeater-block">
        ...
        <input type="text" class="form-control redirect-message-after-input" id="redirect_message_after_<?php echo esc_attr($index); ?>" name="redirect_message_after[<?php echo esc_attr($index); ?>]" value="<?php echo isset($redirect['redirect_message_after']) ? esc_attr($redirect['redirect_message_after']) : ''; ?>" required>
    ...
    <div class="form-repeater-block">
        <label>Preview</label>
        <input type="text" class="form-control redirect-preview-input" id="redirect_preview_<?php echo esc_attr($index); ?>" value="<?php
